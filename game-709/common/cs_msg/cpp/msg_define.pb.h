...
enum CLIENT_MSG_ID {
  ...
  C2S_MSG_GET_GAME_INFO_REQ = 1016,
  ...
  S2C_MSG_SHOWHAND_SEND_MASTER_CARD_REP = 3310,
  S2C_MSG_SHOWHAND_FLUSH_MASTER_CARD_REP = 3311,
  C2S_MSG_SHOWHAND_RECV_MASTER_CARD_REQ = 3312,
  S2C_MSG_SHOWHAND_RECV_MASTER_CARD_REP = 3313,
  ...
  C2S_MSG_BAINIU_CONTROL_CARDTYPE_REQ = 3421,
  S2C_MSG_BAINIU_CONTROL_CARDTYPE_REP = 3422,
  C2S_MSG_BAINIU_CANCEL_CONTROL_CARDTYPE_REQ = 3423,
  S2C_MSG_BAINIU_CANCEL_CONTROL_CARDTYPE_REP = 3424,
  S2C_MSG_BAINIU_REPLAY_CONTROL_CARDTYPE_REP = 3425,
  ...
  S2C_MSG_SANGONGDOU_GAME_FREE_INFO = 5200,
  S2C_MSG_SANGONGDOU_GAME_PLAY_INFO = 5201,
  S2C_MSG_SANGONGDOU_START = 5202,
  C2S_MSG_SANGONGDOU_PLACE_JETTON = 5203,
  S2C_MSG_SANGONGDOU_PLACE_JETTON_REP = 5204,
  S2C_MSG_SANGONGDOU_PLACE_JETTON_BROADCAST = 5205,
  S2C_MSG_SANGONGDOU_GAME_END = 5206,
  S2C_MSG_SANGONGDOU_PLAY_LOG = 5207,
  C2S_MSG_SANGONGDOU_CONTINUOUS_PRESSURE_REQ = 5208,
  S2C_MSG_SANGONGDOU_CONTINUOUS_PRESSURE_REP = 5209
};
bool CLIENT_MSG_ID_IsValid(int value);
const CLIENT_MSG_ID CLIENT_MSG_ID_MIN = C2S_MSG_HEART;
const CLIENT_MSG_ID CLIENT_MSG_ID_MAX = S2C_MSG_SANGONGDOU_CONTINUOUS_PRESSURE_REP;
